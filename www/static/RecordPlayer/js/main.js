...
;(function(window) {
	...
	function loadTurntableAssets(callback) {
		new AbbeyLoad([{ 
			'room1' : '/static/RecordPlayer/mp3/room1.mp3',
			'room2' : '/static/RecordPlayer/mp3/room2.mp3',
			'room3' : '/static/RecordPlayer/mp3/room3.mp3',
			'noise' : '/static/RecordPlayer/mp3/noise1.mp3'
		}], function(bufferList) {
			if( typeof callback === 'function' ) {
				callback(bufferList);
			}
